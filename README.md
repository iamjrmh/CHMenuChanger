...
- **No Python required** - distributed as a standalone `.exe`

---

## 🚀 Quick Start

1. Download `CHMenuChanger.exe` from the [Releases](https://github.com/iamjrmh/CHMenuChanger/releases) page.
2. Run it — no install needed.
3. Click **Browse** and select your `Clone Hero_Data` folder (usually at `Documents\Clone Hero\Clone Hero_Data`).
4. Click **Load & Scan** — the tool scans all asset files and creates backups automatically.
5. Select a background from the left panel.
6. Click **Choose Replacement** and pick your image.
7. Click **Apply & Save** to write the changes directly to your game files.
8. Restart Clone Hero to see the result.
